        ...
        <div className="container mx-auto px-6 relative z-20">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-3xl">
            ...
            <motion.p variants={fadeUp} className="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed max-w-2xl">
              Menghadirkan produk elektrik dan konstruksi bermutu tinggi dengan komitmen penuh pada penggunaan komponen lokal (TKDN) untuk mewujudkan kemandirian industri nasional.
            </motion.p>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="text-center mb-16">
            <h2 className="text-3xl font-heading font-bold text-brand-navy mb-4">Keunggulan Presisi untuk Setiap Kebutuhan Anda</h2>
            <p className="text-brand-dark max-w-2xl mx-auto">Dari manajemen energi hingga sistem penunjang instalasi, HEIVO memproduksi rangkaian perangkat listrik yang dirancang untuk daya tahan ekstrem.</p>
          </motion.div>
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="group bg-white rounded-lg shadow-soft border border-gray-100 p-8">
